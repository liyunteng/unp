...
} sock_opts[] = {{"SO_BROADCAST", SOL_SOCKET, SO_BROADCAST, sock_str_flag},
...
sock_str_linger(union val *ptr, int len)
{
    ...
    if (len != sizeof(struct linger)) {
        ...
        snprintf(buf, sizeof(buf), "l_onoff = %d, l_linger = %d", ptr->linger_val.l_onoff,
                 ptr->linger_val.l_linger);
    }
